---
description: 누적된 orch 에러 로그 조회 — scope-aware (top-level + 모든 mp/errors.jsonl 통합)
...
**예**:
- `/orch:errors` — top-level + 모든 MP 통합, 마지막 20건
- `/orch:errors --tail 50` — 마지막 50건
- `/orch:errors --mp mp-9` — mp-9 scope (live 또는 archive) 만
...
- `/orch:errors --clear --mp mp-9` — 그 MP 만 비움
